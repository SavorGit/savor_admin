...
class TesttuireportController extends BaseController{
	...
	public function mobile_download(){
		...
		$table = 'devp_first_mobile_download';
		$starttime = I('post.starttimefmd','');
		$endtime = I('post.endtimefmd','');
		$tuiModel =  new \Admin\Model\TestTuiRpModel($table);
	...
	public function rplist(){
		...
		$dtype = 1;
		$table = 'devp_first_mobile_interaction_final';
