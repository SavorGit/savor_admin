...
class TestController extends Controller {
    ...
    public function genHotelInfoCache(){
        ...
        $sql ="select box.* ,hotel.id hotel_id from savor_box box 
               ...
               where hotel.id in('258','267','273','327','328','766','818','618',
                                 '445','601','690','676','293','266','60','837',
                                 '839','795','9','85','89','555','18','46','549',
                                 '678','685','28',
                                 '116','129','896','147','552','742','878','177',
                                 '223','833','186','827','34','563','763','238')
