...
class SmallappForscreenRecordModel extends Model{
    ...
    public function cleanTestdata(){
        ...
        foreach ($res_boxdata as $v){
            ...
            unset($v['id'],$v['category_id'],$v['spotstatus'],$v['scene_id'],$v['contentsoft_id'],$v['dinnernature_id'],$v['personattr_id'],$v['remark'],$v['resource_name'],$v['md5_file'],$v['save_type'],$v['file_conversion_status'],$v['box_finish_downtime'],$v['serial_number'],$v['quality_type'],$v['box_play_time'],$v['is_cancel_forscreen'],$v['file_imgnum']);
