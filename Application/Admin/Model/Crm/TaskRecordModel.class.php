...
class TaskRecordModel extends BaseModel{
    ...
    public function getHandleTasks($type){
        $where = array('a.status'=>array('in','0,1'),'a.off_state'=>1,'task.type'=>$type,'task.status'=>1);
        $where['a.add_time'] = array('egt',date('Y-m-01 00:00:00'));
        $fileds = 'a.id,a.task_id,a.hotel_id,a.residenter_id,a.status,a.form_type,a.handle_status,a.audit_handle_status,
        a.img,a.location_hotel_id,a.is_trigger,a.integral_task_id,a.sale_id,a.sale_date,a.reset_time,a.add_time,
