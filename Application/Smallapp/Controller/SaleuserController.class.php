...
class SaleuserController extends BaseController {
    ...
    public function userlist(){
        ...
        $fields = "u.id,u.openid,u.mobile,u.avatarUrl,u.nickName,u.idnumber,hotel.id as hotel_id,hotel.name as hotel_name,u.create_time,IFNULL(i.integral ,0) as integral";
