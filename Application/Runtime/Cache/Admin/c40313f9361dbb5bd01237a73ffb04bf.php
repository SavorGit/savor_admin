...
<div class="pageHeader">
  <form onsubmit="return navTabSearch(this);" id="pagerForm" action="<?php echo ($host_name); ?>/sysmenu/sysmenuList" method="post">
      ...
      <div class="clearfix">
        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
          <div class="tools-group">
            <a class="btn btn-success btn-sm add" href="<?php echo ($host_name); ?>/sysmenu/sysmenuAdd?acttype=0" title="新增模块" target="dialog" mask="true"><i class="fa fa-plus"></i> 新增</a>
          </div>
        </div>
        ...
        <table class="table table-bordered table-striped" targetType="navTab" asc="asc" desc="desc">
          ...
          <tbody data-check="list" data-parent=".table">
            <?php if(is_array($sysmenulist)): $i = 0; $__LIST__ = $sysmenulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vlist): $mod = ($i % 2 );++$i;?><tr target="sid_user">
              ...
              <td data-title="模块ID"><?php echo ($key+1); ?></td>
              <td data-title="模块名称"><a href="#" class="click-able-title"><?php echo ($vlist["modulename"]); ?></a></td>
              <td data-title="节点KEY">
              ...
              <td class="table-tool" data-title="操作">
                <div class="tools-edit">
                  <a data-tip="修改" target="dialog" mask="true" href="<?php echo ($host_name); ?>/sysmenu/sysmenuAdd?id=<?php echo ($vlist["id"]); ?>&acttype=1" class="btn btn-success btn-icon">
