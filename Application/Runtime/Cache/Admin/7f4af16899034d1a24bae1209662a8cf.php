...
<div class="pageContent">
  <form id="dropbase-form" method="post" action="<?php echo ($host_name); ?>/article/doAddvideo" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone)" >
    <input type="hidden" id="video_id" name="id" value="<?php echo ($vainfo["id"]); ?>">
        ...
        <div class="tab-content">
          <div id="tab1" class="tab-pane active fade in">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-10">
                <select name="cate" class="form-control bs-select" title="请选择.." required>
                  <?php if(is_array($vcainfo)): $i = 0; $__LIST__ = $vcainfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row['id']); ?>" <?php if($row['id'] == $vainfo['category_id']): ?>selected<?php endif; ?> > <?php echo ($row['name']); ?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-10">
                <input name="title" type="text" value="<?php echo ($vainfo["title"]); ?>"  minlength="2" maxlength="30" class="form-control" required/>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-xs-12 col-sm-2 control-label">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-10">
                ...
                <div class="col-md-2 col-sm-12">
                  <label>点播视频<input type="radio" required name="r1" value="1" <?php if($vainfo['vid_type'] == 1): ?>checked="checked"<?php endif; ?>
                    ></label>
                </div>
                <div class="col-md-6 col-sm-12">
                  <label>非点播视频<input type="radio" required name="r1"  value="2" <?php if($vainfo['vid_type'] == 2): ?>checked="checked"<?php endif; ?>></label>
                </div>
            ...
            <div class="form-group row"  >
              <div id="dianbo" style="display: none;" class="col-md-1 col-sm-2 col-md-offset-2 ">
                <div class="form-group row">
                  <div class="col-xs-12 col-sm-10">
                    ...
                    <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                      <a data-target="#modal-file" href="<?php echo ($host_name); ?>/resource/uploadResource?filed=media_id&rtype=1" data-browse-file>
                        <?php if(($vainfo['videooss_addr'] == 'NULL') OR $vainfo['videooss_addr'] == ''): ?><img id="media_idimg"  src="/Public/admin/assets/img/noimage.png" border="0"/>
                          <?php else: ?>
                          <img id="media_idimg" src="<?php echo ($vainfo["videooss_addr"]); ?>" border="0" /><?php endif; ?>
                        <span id="media_idimgname"><?php echo ($vainfo["videoname"]); ?></span>
                      </a>
                    </div>
                    <div>
                      <a class="btn btn-success btn-file" data-target="#modal-file" href="<?php echo ($host_name); ?>/resource/uploadResource?filed=media_id&rtype=1" data-browse-file>
                        选择视频
                      </a>
                      <input type="hidden" name="media_id" id="media_id" value="">
                      <a id="bntt" href="javascript:;" class="btn btn-danger" data-remove-file="/Public/admin/assets/img/noimage.png">
                        删除 </a>
                    </div>
                  </div>
              ...
              <div class="col-xs-5 col-sm-5 col-md-offset-2">


                <input name="yunhref" type="text" value="<?php echo ($vainfo["tx_url"]); ?>"  minlength="2"  class="form-control" placeholder="QQ云链接" required/>
              </div>
            ...
            <div class="form-group row">
              <div class="col-xs-4 colcol-sm-4 col-md-offset-3" id="nei" ><h2 id="xuandian" style="font-size:15px;">您选择的点播视频是<?php echo $vinfo['media_name']?></h2></div> <input type="hidden" name="videoid" value="<?php echo ($vinfo["media_key_id"]); ?>">
              <div class="col-xs-12 col-sm-10">
          ...
          <div class="form-group row">
            <div class="form-inline">
              ...
              <div class="form-group col-md-12 col-xs-12 col-sm-12" >
                ...
                <span class="form-control col-sm-2">分</span><input style="width:50px;" min="0" max="59"  alt="数字"  name="minu" id="minu"  type="number"  value="<?php if($vainfo["duration"] > 0): echo (floor($vainfo['duration']/60)); else: endif; ?>"  class="form-control col-sm-2" />
          ...
          <div class="form-group row">
            <div class="form-inline">
              ...
              <div class="form-group col-md-12 col-xs-12 col-sm-12" >
                ...
                <span class="form-control col-sm-2">秒</span><input style="width:50px;" min="0" max="59" required  alt="数字" id="seco" name="seco"  type="number"  value="<?php if($vainfo["duration"] > 0): echo ($vainfo['duration']%60); else: endif; ?>"  class="form-control col-sm-2" />
              </div>
            </div>
          ...
          <div class="form-group row" id="biaoqian">
            ...
            <div class="modal fade" id="myModa" style="z-index:999;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <!--小-->
            <div style="z-index: 999;" class="modal fade" id="myModaa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button style="width:20px;height:20px;" type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-10">
                <script id="editor" type="text/plain" class="ueditor-init" name="content" style="height: 250px; width: 100%"><?php echo (html_entity_decode($vainfo["content"],ENT_COMPAT)); ?></script>
              </div>
            </div>
            <!--<div class="form-group row">
              <label class="col-xs-12 col-sm-2 control-label">
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    var rval = $("#video_id").val();
    if (rval == 0) {
      $("#dianbo").css('display', 'none');
      $("#nei").css('display', 'none');
    } else {
      var rval = $("input[name='r1']:checked").val();
      if (rval == 1) {
        $("#dianbo").css('display', 'block');
    ...
    $("input[name='r1']").click(
            function () {
              ...
              if (val == 1) {
                ...
                $("#dianbo").css('display', 'none');
                $("#meso").css('display', 'none');
                $("#nei").css('display', 'none');
              }
            }
    );
    $("select[name='videomedia']").change(
            function () {
              var vid = $(this).find("option:selected").text();
              var addr = $(this).find("option:selected").attr("addr");

              $("input[name='videoid']").val(vid);
              $("input[name='videoaddr']").val(addr);

              $("#xuandian").html("您选择的点播视频是"+$(this).find("option:selected").text());
              $("#meso").css('display', 'none');
            }
    ...
    $('#bntt').click(function(){
    	$('#media_idimgname').html('');
    	$('#media_idimg').show();
    	$('#media_idimg').prop('src','/Public/admin/assets/img/noimage.png');
    	$('#media_id').val("");
    })


    $("#selectdian").click(function(){
      $("#meso").css('display', 'block');
    });
