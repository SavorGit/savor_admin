...
<div class="pageContent">
  <form method="post" action="<?php echo ($host_name); ?>/device/doAddTv" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return validateCallback(this, dialogAjaxDone)">
    <input type="hidden" name="id" value="<?php echo ($vinfo["id"]); ?>">
    <input type="hidden" name="box_id" value="<?php echo ($vinfo["box_id"]); ?>">
      ...
      <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-10">
         <select name="state" class="form-control bs-select" title="请选择..." required>
              ...
              <option value="2" <?php if($vinfo["state"] == 2): ?>selected<?php endif; ?>  >冻结</option>
