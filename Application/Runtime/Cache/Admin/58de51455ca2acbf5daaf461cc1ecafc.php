    ...
    <div class="searchBar">
      <div class="clearfix">
          ...
          <div class="tools-group s2">
            <a class="btn btn-success btn-sm add" href="<?php echo ($host_name); ?>/test/ueditior" title="测试百度编辑器" target="dialog" mask="true">
            <i class="fa fa-sign-in"></i><span>测试百度编辑器</span></a>
            <a class="btn btn-success btn-sm add" href="<?php echo ($host_name); ?>/test/echarts" title="测试Echarts" target="navTab" rel="test/echarts">
            <i class="fa fa-plus"></i><span>测试Echarts</span></a>
          </div>
        </div>
