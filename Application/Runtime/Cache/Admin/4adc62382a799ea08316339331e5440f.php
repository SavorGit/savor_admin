...
<div class="pageContent">
  <form method="post" name=theform action="<?php echo ($host_name); ?>/send/doAddMedia" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogAjaxDone)">
...
function send_request()
{
    ...
    if (xmlhttp!=null)
    {
        serverUrl = '<?php echo ($host_name); ?>'+'/send/getOssParams';
	...
	init: {
		...
		FileUploaded: function(up, file, info) {
            if (info.status == 200)
            {
                ...
                document.getElementById('oss_addr').value = file.name;
            }
