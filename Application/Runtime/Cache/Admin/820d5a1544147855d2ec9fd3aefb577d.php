...
<head>
  ...
  <title>寻味管理系统</title>
  <link href="<?php echo ($site_host_name); ?>/min?b=./test/Public/admin/assets/plugins&f=font-awesome/css/font-awesome.min.css,simple-line-icons/css/simple-line-icons.css,bootstrap/css/bootstrap-custom.css,bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css,bootstrap-fileinput/bootstrap-fileinput.css,jquery-tags-input/jquery.tagsinput.css,bootstrap-switch/css/bootstrap-switch.min.css,bootstrap-select/bootstrap-select.min.css,footable/footable.css,dropzone/css/dropzone.css,icons-files/file.css,baidumap/searchinfowindow.min.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo ($site_host_name); ?>/min?b=./test/Public/admin/assets/css&f=core.css,components.css,plugins.css,style.css" rel="stylesheet" type="text/css" />
  <link rel="shortcut icon" href="/test/Public/admin/assets/img/favicon.png"/>
  <link rel="apple-touch-icon" sizes="57*57" href="/test/Public/admin/assets/img/phoneicon.png">
  <link rel="apple-touch-icon" sizes="72*72" href="/test/Public/admin/assets/img/phoneicon.png">
  <link rel="apple-touch-icon" sizes="114*114" href="/test/Public/admin/assets/img/phoneicon.png">
  <link rel="apple-touch-icon" sizes="144*144" href="/test/Public/admin/assets/img/phoneicon.png">
</head>
...
<body scroll="no">
  ...
  <script src="/test/Public/admin/assets/js/main.js"></script>
  ...
  $(function() {
    DWZ.init({
      loginUrl:"/test/admin/Login/login", //跳到登录页面
  ...
  function loadEcharts() {
    ...
    script.type = "text/javascript";
    script.src = "/test/Public/admin/assets/plugins/echart/echarts-all.js";
