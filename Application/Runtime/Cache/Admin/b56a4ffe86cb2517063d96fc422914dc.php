        ...
        <table class="table table-bordered table-striped" targetType="navTab" asc="asc" desc="desc">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vlist): $mod = ($i % 2 );++$i;?><tr target="sid_user">
              ...
              <td data-title="是否选择洒楼">
                ...
                <?php if($vlist["count"] == 0): ?><a data-tip="请选择酒楼" rel="menu/selecthotel" class="btn btn-success " target="navTab" mask="true" href="<?php echo ($host_name); ?>/menu/selecthotel?menuid=<?php echo ($vlist["id"]); ?>&menuname=<?php echo ($vlist["menu_name"]); ?>">请选择酒楼</a>
                  <?php else: ?> <a data-tip="酒楼数为" class="btn btn-success " target="navTab" mask="true" rel="menu/selecthotel"
href="<?php echo ($host_name); ?>/menu/gethotelinfo?menuid=<?php echo ($vlist["id"]); ?>&menuname=<?php echo ($vlist["menu_name"]); ?>"><?php echo ($vlist["count"]); ?></a><?php endif; ?>
              </td>
              <td data-title="节目详情">
              ...
              <td class="table-tool" data-title="操作日志">
                ...
                <td class="table-tool" data-title="酒楼日志">
                    <div class="tools-edit">
                        <a data-tip="日志查看" target="dialog" mask="true"
                           href="<?php echo ($host_name); ?>/menu/gethotellog?mid=<?php echo ($vlist["id"]); ?>&name=<?php echo ($vlist["menu_name"]); ?>"
                           class="btn btn-success btn-icon">
                            <i class="fa fa-search-minus"></i>
                        </a>
                    </div>
              ...
              <td class="table-tool" data-title="操作">
                <div class="tools-edit">
                  ...
                  <a data-tip="修改" target="dialog" title="修改节目单列表" rel="menu/getlist"
                     ...
                     href="<?php echo ($host_name); ?>/menu/addmen?id=<?php echo ($vlist["id"]); ?>&type=2&name=<?php echo ($vlist["menu_name"]); ?>" rel="xiugaicai"
                     class="btn btn-success btn-icon">
                    ...
                    <a data-tip="复制新增" target="dialog" title="复制新增节目单"  mask="true"
                       ...
                       href="<?php echo ($host_name); ?>/menu/addmen?id=<?php echo ($vlist["id"]); ?>&type=2&name=<?php echo ($vlist["menu_name"]); ?>&pctype=1"
                       class="btn btn-success btn-icon">
