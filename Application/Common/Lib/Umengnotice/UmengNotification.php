...
abstract class UmengNotification {
	...
	protected $umeng_appkey = "";
	protected $umeng_appmaster = "";
	protected $umeng_ios_key = "";
	protected $umeng_ios_master = "";
	...
	function __construct() {
		$this->youmengConfig = C('UMENBAI_API_CONFIG');



	}

	function setParam($prm){
		$umeng_config = $this->youmengConfig;
		$this->umeng_appkey = $umeng_config[$prm]['android_appkey'];
		$this->umeng_appmaster = $umeng_config[$prm]['android_master_secret'];
		$this->umeng_ios_key = $umeng_config[$prm]['ios_appkey'];
		$this->umeng_ios_master = $umeng_config[$prm]['ios_master_secret'];
	}
