...
use Umengnotice\UmengNotification;
use Think\Exception;
...
abstract class IOSNotification extends UmengNotification {
	...
	protected $APS_KEYS    = array("alert", "badge", "sound", "content-available","title" ,"text",
	                               "after_open","display_type"
	);
	...
	function setCustomizedField($arr) {
		foreach($arr as $k=>$v) {
			$this->data["payload"][$k] = $v;
		}
	}
}